...
public class GlobalExceptionHandler {
    ...
    public ResponseEntity<ApiError> handleRehearsalNotFoundException(
            RehearsalNotFoundException exception,
            HttpServletRequest request
    ) {
        ApiError apiError = new ApiError(
                Instant.now(),
    ...
    public ResponseEntity<ApiError> handleBandAccessDeniedException(
            BandAccessDeniedException exception,
            HttpServletRequest request
    ) {
        ApiError apiError = new ApiError(
                Instant.now(),
    ...
    @ExceptionHandler(LastBandOwnerException.class)
    public ResponseEntity<ApiError> handleLastBandOwnerException(
            LastBandOwnerException exception,
            HttpServletRequest request
    ) {
        ApiError apiError = new ApiError(
                Instant.now(),
